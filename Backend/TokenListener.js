...
import { updateClaim } from 'functions'

const web3 = new Web3('wss://mainnet.infura.io/ws/v3/2f7b8a89dff14cd19a384dcf799f4ebd');

// async function tokenListener(address, abi) {
//     const wallets = await Wallet.find()

//     const contract = new web3.eth.Contract(abi, address)
//     await contract.events.Transfer({
//         fromBlock: 0,
//         filter: {from: //contract address}
//     })
//     .on('data', event => {
//         //use updateClaim function
//     })
...
async function test() {
    ...
    contract.events.Transfer({
            ...
            .on('data', event => {
                updateClaim(event.returnValues.Result.from, event.returnValues.Result.to, event.returnValues.Result.value)
            })
